...
extern volatile unsigned int *print_lock;
extern volatile unsigned int *done_init;
extern volatile unsigned int *done_memcpy;
extern volatile unsigned int *done_calc;
extern volatile unsigned int *done_eval;
