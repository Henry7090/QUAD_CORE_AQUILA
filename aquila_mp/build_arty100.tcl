...
set proj_name "multicore_aquila"
...
set files [list \
  ...
  [file normalize "$origin_dir/src/core_rtl/bram_dp.v" ]\
  [file normalize "$origin_dir/src/core_rtl/clint.v" ]\
  [file normalize "$origin_dir/src/core_rtl/core_top.v" ]\
  [file normalize "$origin_dir/src/core_rtl/coherence_unit.v" ]\
  ...
  [file normalize "$origin_dir/src/core_rtl/L2cache.v" ]\
  [file normalize "$origin_dir/src/core_rtl/L2cache_arbiter.v" ]\
...
set_property -dict [list \
    ...
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {41.666667} \
